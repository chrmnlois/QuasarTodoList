		...
		<div class="mobile-view relative-position q-px-lg">
			<div class="relative-position flex justify-between items-center full-height q-py-lg">
				<div>
					<q-icon
						v-if="MenuBtnState"
						class="bg-amber-4 onboarding-text-accent-1 onboarding-border-radius-8 q-pa-xs"
						size="sm"
				...
				<div
					:class="`onboarding-header-content absolute ${SearchBtnState ? 'left-right-30' : 'left-right-24'}`"
				>
				...
				<div>
					<div class="flex items-center" v-if="SearchBtnState">
						...
						<q-icon
							...
							class="q-pl-md onboarding-text-accent-1 absolute right-0 magnify"
							name="iconfont icon-search-line"
						/>
					</div>
				</div>
