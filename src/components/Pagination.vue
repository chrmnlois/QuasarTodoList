<template>
	<div class="flex items-center">
		<div class="text-14 onboarding-text-accent-2 q-mr-md md">Rows</div>
		<div>
			<q-select
				borderless
				v-model="selectedRow"
		...
		<div class="onboarding-pagination-container flex justify-center items-center">
			<q-pagination
				...
				@update:model-value="updatePagination()"
			/>
			<div class="onboarding-pagination-select-input text-no-wrap">
				<q-select
					class="onboarding-input-field"
					v-model="selectedRow"
					dense
					rounded
					outlined
