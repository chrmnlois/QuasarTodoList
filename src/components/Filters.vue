<template>
	<div class="filters-component">
		<div :class="isLabelVisible && 'flex items-center'">
			<div v-if="isLabelVisible" class="text-14 onboarding-text-accent-1 q-mr-md">Filters:</div>
			<div class="flex justify-end">
				<q-select
					v-if="isSelectVisible"
					class="
						minmax-width
						onboarding-border-radius-50 onboarding-border-accent-0 onboarding-select-field
						height-31
						q-mr-md
					"
					dense
				...
				>
					<template v-slot:after-options>
						...
						<div v-if="isDateRangeVisible" class="q-px-sm">
							<q-item-section class="onboarding-text-accent-2 q-my-sm">Custom Range</q-item-section>
							<q-form ref="formDateRange" greedy>
								<div>
									<label>From</label>
									<q-input
										class="
											onboarding-border-accent-0 onboarding-border-radius-5 onboarding-input-field
											filter-date-field
											q-px-sm
											label-accent-2
										"
								...
								<div class="q-mt-xs">
									...
									<q-input
										class="
											filter-date-field
											onboarding-border-radius-5 onboarding-input-field onboarding-border-accent-0
											label-accent-2
											q-px-sm
										"
										v-model="toDate"
							...
							<div class="q-mb-md q-mt-sm">
								<q-btn
									...
									class="
										apply-btn
										onboarding-border-radius-15 onboarding-bg-accent-0
										border-white
										full-width
									"
									label="Apply"
