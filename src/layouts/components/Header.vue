        ...
        <div class="tablet-desktop-view row justify-between q-px-lg q-py-md">
          <div class="col-8 col-md-5 flex items-center">
            ...
            >
              <template v-slot:prepend>
                <q-icon
                  class="q-pl-md onboarding-text-accent-1"
                  name="search"
                />
              </template>
            </q-input>
          ...
          <div class="col-4 col-md-6">
            <div class="row items-center onboarding-text-accent-0 justify-end">
              ...
              <div class="tablet-materials col-auto q-pr-sm">
                <q-icon
                  class="onboarding-text-accent-1 text-hover-accent-1 bg-hover-accent-0 relative-postion"
                  ...
                  >
                    ...
                    >
                      <div class="text-left">
                        ...
                        <div class="text-accent-0 q-mt-xs text-9">
                          David Lee
                        </div>
                      </div>
              ...
              >
                ...
                <q-icon class="q-ml-md" name="person" size="sm" color="black" />

                <!--<div class="desktop-materials">
                  <q-icon
                    class="q-pa-none onboarding-text-primary"
                    size="sm"
                    name="expand_more"
                  />
                </div>
                 <div class="profile-container absolute">
                  <div
                    class="content bg-white q-px-xs q-py-md shadow-3 text-12 text-accent-1"
                  >
