<template>
	<div>
		<q-header class="onboarding-header onboarding-bg-secondary">
			<div>
				<MobileHeader />
				<!-- <div class="mobile-view row items-center justify-between q-px-md">
        <div><q-icon class="cursor-pointer onboarding-text-primary text-hover-accent-0 opacity-7 q-my-lg" size="sm" name="iconfont icon-arrow-left" /></div>
        <div class="text-23">User Management</div>
        <div><q-icon class="cursor-pointer onboarding-text-primary text-hover-accent-0 opacity-7" size="sm" name="iconfont icon-add" /></div>
        </div> -->
				<div class="tablet-desktop-view row justify-between q-px-lg q-py-md">
					<div class="col-8 col-md-5 flex items-center">
						<q-input class="full-width main-search" dense borderless placeholder="Search Filter...">
							<template v-slot:prepend>
								<q-icon class="q-pl-md onboarding-text-accent-0" name="search" />
							</template>
						</q-input>
					</div>
					<div class="col-4 col-md-6">
						<div class="row items-center onboarding-text-accent-0 justify-end">
							<div class="tablet-materials col-auto q-pr-sm">
								<q-icon
									class="onboarding-text-accent-1 text-hover-accent-1 bg-hover-accent-0"
								...
								>
									<div class="absolute bg-white notification-container shadow-3 q-px-xs q-py-sm">
										<div class="flex justify-between q-px-xs items-center text-10">
											...
											<div class="text-accent-1">See all</div>
										</div>
										<div class="flex justify-between text-10 q-mt-xs q-pa-xs bg-hover-accent-4">
											<div class="text-left">
												<div class="text-accent-1">I just read your message.</div>
												<div class="text-accent-0 q-mt-xs text-9">David Lee</div>
											</div>
											<span class="ellipse bg-accent-0 float-right"></span>
										</div>
										<div class="flex justify-between text-10 q-mt-xs q-pa-xs bg-hover-accent-4">
											<div class="text-left">
												<div class="text-accent-1">I just read your message.</div>
							...
							>
								...
								<div class="desktop-materials">
									<q-icon class="q-pa-none onboarding-text-primary" size="sm" name="expand_more" />
								</div>
								<div class="profile-container absolute">
									<div class="content bg-white q-px-xs q-py-md shadow-3 text-12 text-accent-1">
